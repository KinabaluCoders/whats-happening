// generate a random date based on Date Start and Date End
// http://stackoverflow.com/a/9035732
...
function debugGenerate_loremIpsum(maxWordCount, minWordCount)
{
    ...
    if(!minWordCount) minWordCount = 15;
    if(!maxWordCount || maxWordCount < minWordCount) maxWordCount = minWordCount + 85;
